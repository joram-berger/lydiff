...
class CliOptions(options.Options):

    def __init__(self):
        super().__init__()
        self._set_options(self._cli_options())
    ...
    def _cli_options(self):
        ...
        parser.add_argument('-l', '--lilypondoptions', type=str, nargs='+',
            default=self._config['lilypondoptions'],
        ...
        parser.add_argument('-d', '--diff', type=str, default=self._config['diff'],
...
# TODO: Remove this once it is obsolete (i.e. the object approach works)
def cli_options():
